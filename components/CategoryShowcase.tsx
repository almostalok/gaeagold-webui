    ...
    <>
      ...
      <section className="py-24 bg-[#f8f7f5] overflow-hidden relative">
        <motion.div 
          ...
          className="mx-auto max-w-[1400px] px-4 md:px-8 lg:px-12 relative z-10"
        >
          <motion.div variants={itemVariants} className="mx-auto max-w-2xl text-center flex flex-col items-center mb-16">
